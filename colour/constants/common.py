...
EPSILON: float = np.finfo(np.float_).eps
"""
...
DEFAULT_FLOAT_DTYPE: DTypeFloating = np.sctypeDict.get(
    ...
    np.float64)  # type: ignore[assignment]
"""
Default floating point number dtype.
"""

DEFAULT_INT_DTYPE: Union[np.int32, np.int64] = np.sctypeDict.get(
    os.environ.get('COLOUR_SCIENCE__INT_PRECISION', 'int64'),
    np.int64)  # type: ignore[assignment]
"""
