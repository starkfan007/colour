...
def is_integer(a: Any) -> Boolean:
    """
    Returns whether given variable :math:`a` is an :class:`int`-like variable
    ...
    -------
    :class:`bool`
        Whether variable :math:`a` is an :class:`int`-like variable.
...
def filter_mapping(mapping: Mapping,
                   ...
                   flags: Union[int, RegexFlag] = re.IGNORECASE) -> dict:
    """
