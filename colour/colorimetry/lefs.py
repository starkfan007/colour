...
def mesopic_weighting_function(
    ...
    photopic_lef = (SDS_LEFS_PHOTOPIC['CIE 1924 Photopic Standard Observer']
                    if photopic_lef is None else photopic_lef)

    scotopic_lef = (SDS_LEFS_SCOTOPIC['CIE 1951 Scotopic Standard Observer']
                    if scotopic_lef is None else scotopic_lef)
...
def sd_mesopic_luminous_efficiency_function(
    ...
    shape = SpectralShape(
        np.max([photopic_lef.shape.start, scotopic_lef.shape.start]),
        np.min([photopic_lef.shape.end, scotopic_lef.shape.end]),
        np.max([photopic_lef.shape.interval, scotopic_lef.shape.interval]))
